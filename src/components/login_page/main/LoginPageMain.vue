    ...
    <el-aside class="form">
      <el-form ref="ruleFormRef"
        ...
        <h2 style="letter-spacing: 1px; font-size: 22px; font-weight: 600; text-align: left; margin: 0;line-height: 25px">
          <span style="color: #5cb85c">英语词汇小助手 </span>登录
        </h2>
        <hr style="margin-bottom: 20px;border: 0;border-top: 1px solid rgba(162,169,182,0.25)"/>
        <el-form-item label="邮箱：" prop="username">
          <el-input v-model="ruleForm.username" size="large" :prefix-icon="User" placeholder="请输入邮箱"
                    maxlength="18"/>
        </el-form-item>
...
const rules = {
  username: [
    ...
    {min: 0, max: 18, message: '长度在 18 个字符', trigger: 'blur'}
  ],
  password: [
    {required: true, message: '请输入密码', trigger: 'blur'},
    {min: 0, max: 20, message: '长度在 6 到 20 个字符', trigger: 'blur'}
  ],
}
